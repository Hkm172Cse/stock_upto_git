       ...
       <div class="row">
                    <div class="col-lg-12 due-header-box">
                                ...
                                <div class="row col-12">
                                  <h4 class="col-6 card-title text-info">Discount Records</h4>
                                    ...
                                    <div class="basic-dropdown col-6">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                              <a class="dropdown-item" id="totalDue" href="#">Total Discount</a> 
   ...
   $(document).ready(function(){
    $('#customer_due').keyup(function(){
        ...
        if(customarName == ""){
          ...
          $.ajax({
                url:"<?php echo base_url()?>customerDiscount",
                type:"post",
                dataType:"json",
                data:{
                ...
                success: function(data){
                  ...
                  if(data.length == 0){
                      ...
                      for(var key in data){
                        ...
                        customTotal += parseInt(data[key]['discount']);
                        ...
                        saleBox +="<h6 class='font-weight-bold'>"+"Total Price = "+data[key]['prices']+"</h6>";
                        saleBox +="<h6 class='font-weight-bold'>"+"Discount = "+data[key]['discount']+"</h6>";
                        saleBox +="<h6 class='due font-weight-bold' data-id="+data[key]['due']+" id='due_id'>"+"Payment = "+data[key]['dis_price']+"</h6>";
                        saleBox += "</div>";
  ...
  $(document).on("click", "#paymentBtn", function(){
    ...
    $(document).on("click", "#totalDue", function(e){
        ...
        //   var chooseData = $('#custom_date_get').val();  
            $('.dropdown-toggle').html("Total Discount")
          $.ajax({
              url:"<?php echo base_url()?>fetchDiscount",
              type:"post",
              dataType:"json",
              success: function(data){
                console.log(data);
                ...
                var customTotal = 0;
                      ...
                      for(var key in data){
                        ...
                        saleBox +="<h5 class='font-weight-light'>"+data[key]['products']+"</h5>";
                        saleBox +="<h5 class='font-weight-light'>"+"Total Amount = "+data[key]['total_amount']+"</h5>";
                        saleBox +="<h5 class='font-weight-light'>"+"Discount = "+data[key]['discount']+"</h5>";
...
//SEE ALL SALE EXPENSE YOUR DATE WISE END FUNCTION
    ...
    $(document).on("click", "#today", function(e){
            ...
            $('.dropdown-toggle').html("Today")
              ...
              $.ajax({
              url:"<?php echo base_url()?>todayDiscount",
              type:"post",
              dataType:"json",
              data:{
                created:actualDate
              ...
              success: function(data){
                ...
                let todayTotal = 0;      
                      ...
                      for(var key in data){
                        todayTotal += parseInt(data[key]['discount']);
                        saleBox +="<div class='card'>";
                        saleBox += "<div class='card-body'>";
                        saleBox += "<div class='float-left'>";
                        saleBox +="<h6 class='font-weight-light'>"+data[key]['created']+"</h6>";
            ...
            console.log(actualMonth)
              ...
              success: function(data){
                ...
                let thisMonthTotal = 0;      
                      ...
                      for(var key in data){
                        thisMonthTotal += parseInt(data[key]['discount']);
                        saleBox +="<div class='card'>";
                        saleBox += "<div class='card-body'>";
                        saleBox += "<div class='float-left'>";
                        saleBox +="<h6 class='font-weight-light'>"+data[key]['created']+"</h6>";
